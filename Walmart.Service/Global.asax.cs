...
namespace Walmart.Service
{
    public class Global : System.Web.HttpApplication
    {
        ...
        {
            routeCollection.Add(new System.Web.Routing.Route("cidades/add/{*pathInfo}", new WebServiceRouteHandler("~/Incluir.asmx")));
            ...
            routeCollection.Add(new System.Web.Routing.Route("scidades/{codCidade}", new WebServiceRouteHandler("~/Obter.asmx")));
        }
