...
namespace Walmart.Data
{
    public class CidadeDAO : DataDAO
    {
        ...
        public static void Adicionar(Cidade cidade)
        {
            using (SqlConnection conn = DataDAO.Conection())
            {
                ...
                try
                {
                    ...
                    {
                        ws.Url = "http://localhost:8080/Cidades/Add";
                        ws.Add(ConverterWCFInclusao(cidade));
                    }
        ...
        public static void Atualizar(Cidade cidade)
        {
            using (SqlConnection conn = DataDAO.Conection())
            {
                ...
                try
                {
                    ...
                    {
                        ws.Url = "http://localhost:8080/Cidades/" + cidade.Codigo.ToString();
                        ws.Update(ConverterWCFAlteracao(cidade));
                    }
                    trans.Commit();
                }
                catch (Exception)
        ...
        public static Cidade ObterCidadeXml(int codigo)
        {
            ...
            {
                ws.Url = "http://localhost:8080/sCidades/" + codigo.ToString();
        ...
        public static void Delete(int codigo)
        {
            using (SqlConnection conn = DataDAO.Conection())
            {
                ...
                try
                {
                    ...
                    {
                        ws.Url = "http://localhost:8080/dCidades/" + cidade.Codigo.ToString();
                        ws.Delete();
                    }
                    trans.Commit();
                }
        ...
        private static upd.Cidade ConverterWCFAlteracao(Cidade cidade)
        {
        ...
        private static add.Cidade ConverterWCFInclusao(Cidade cidade)
        {
